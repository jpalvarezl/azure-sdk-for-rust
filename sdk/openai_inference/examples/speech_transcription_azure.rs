...
async fn main() {
    ...
    let mut file = File::open("./sdk/openai_inference/assets/JP_it_is_rainy_today.wav")
    ...
    let create_transcription_request =
        CreateTranscriptionRequest::new_as_text(file_contents, "JP_it_is_rainy_today.wav");
    let response = openai_client
        .create_speech_transcription(
            "whisper-deployment",
